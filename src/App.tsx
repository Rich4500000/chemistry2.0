...
import { Layers, Zap, Hexagon, Hammer, Box, CircleDot, TestTube } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

type View = 'molecular' | 'metallic' | 'covalent' | 'ionic' | 'diamondrings' | 'custom' | 'organic';
...
export default function App() {
  ...
  return (
    <div className="flex h-screen w-full bg-slate-50 font-sans overflow-hidden">
      {/* Sidebar Navigation */}
      <nav className="w-20 md:w-64 bg-slate-900 text-slate-300 flex flex-col items-center md:items-start py-8 border-r border-slate-800 shrink-0">
