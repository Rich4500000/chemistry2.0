...
const PzOrbitals = ({ positions }: { positions: THREE.Vector3[] }) => {
  ...
  return (
    <group>
      <instancedMesh ref={topRef} args={[undefined as any, undefined as any, positions.length]} material={topMat}>
        <sphereGeometry args={[0.35, 12, 12]} />
      </instancedMesh>
      <instancedMesh ref={bottomRef} args={[undefined as any, undefined as any, positions.length]} material={bottomMat}>
        <sphereGeometry args={[0.35, 12, 12]} />
      </instancedMesh>
    </group>
  );
