...
const PzOrbitals = ({ positions }: { positions: THREE.Vector3[] }) => {
  ...
  return (
    <group>
      <instancedMesh ref={topRef} args={[null as any, null as any, positions.length]} material={topMat}>
        <sphereGeometry args={[0.35, 16, 16]} />
      </instancedMesh>
      <instancedMesh ref={bottomRef} args={[null as any, null as any, positions.length]} material={bottomMat}>
        <sphereGeometry args={[0.35, 16, 16]} />
      </instancedMesh>
    </group>
  );
